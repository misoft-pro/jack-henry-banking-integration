 ...
 *                         the calculation of the available balance for the purpose of bill payment
 *                         requests. &lt;/ElemDesc&gt;&lt;/Jx&gt;
 * </pre>
 * 
 * 
 * <p>Java class for BillPayAvlBalCode_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BillPayAvlBalCode_Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "BillPayAvlBalCode_Type", propOrder = {
    "value"
})
public class BillPayAvlBalCodeType {
