...
/**
 * The code that references how the transfer should behave
 *                 if the From AcctId does not have sufficient funds to cover the transfer request 
 * <pre>
 ...
 * 
 * 
 * <p>Java class for FutXferNSFCode_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FutXferNSFCode_Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "FutXferNSFCode_Type", propOrder = {
    "value"
})
public class FutXferNSFCodeType {
