...
/**
 * Search specific message request headers
 * 
 * <p>Java class for SrchMsgRqHdr_CType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SrchMsgRqHdr_CType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="jXchangeHdr" type="{http://jackhenry.com/jxchange/TPG/2008}jXchangeHdr_CType"/&gt;
 *         &lt;element name="MaxRec" type="{http://jackhenry.com/jxchange/TPG/2008}MaxRec_Type"/&gt;
...
@XmlType(name = "SrchMsgRqHdr_CType", propOrder = {
    "jXchangeHdr",
    "maxRec",
    "cursor",
    "ver1",
...
public class SrchMsgRqHdrCType {

    @XmlElement(required = true)
    protected JXchangeHdrCType jXchangeHdr;
    @XmlElement(name = "MaxRec", required = true)
    protected MaxRecType maxRec;
     ...
     *     
     */
    public void setMaxRec(MaxRecType value) {
        this.maxRec = value;
    }
