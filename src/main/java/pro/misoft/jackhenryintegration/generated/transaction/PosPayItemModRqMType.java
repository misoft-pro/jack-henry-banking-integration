...
/**
 * <p>Java class for PosPayItemModRq_MType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PosPayItemModRq_MType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="PosPayItemId" type="{http://jackhenry.com/jxchange/TPG/2008}PosPayItemId_Type"/&gt;
...
@XmlType(name = "PosPayItemModRq_MType", propOrder = {
    "msgRqHdr",
    "accountId",
    "posPayItemId",
    "posPayItemInfoRec",
...
public class PosPayItemModRqMType {

    @XmlElement(name = "MsgRqHdr", required = true)
    protected MsgRqHdrCType msgRqHdr;
    @XmlElement(name = "AccountId", required = true)
    protected AccountIdCType accountId;
    @XmlElement(name = "PosPayItemId", required = true)
    protected PosPayItemIdType posPayItemId;
    @XmlElementRef(name = "PosPayItemInfoRec", namespace = "http://jackhenry.com/jxchange/TPG/2008", type = JAXBElement.class, required = false)
    protected JAXBElement<PosPayItemInfoRecCType> posPayItemInfoRec;
     ...
     * @return
     *     possible object is
     *     {@link PosPayItemIdType }
     *     
     */
    public PosPayItemIdType getPosPayItemId() {
        return posPayItemId;
    }
     ...
     *     
     */
    public void setPosPayItemId(PosPayItemIdType value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PosPayItemInfoRecCType }{@code >}
     *     
     */
    public JAXBElement<PosPayItemInfoRecCType> getPosPayItemInfoRec() {
     ...
     *     
     */
    public void setPosPayItemInfoRec(JAXBElement<PosPayItemInfoRecCType> value) {
