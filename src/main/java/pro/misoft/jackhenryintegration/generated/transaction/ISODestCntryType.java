 ...
 *                         Standardization (ISO) used to identify the destination country for
 *                         international items in accord with NACHA standards&lt;/ElemDesc&gt;&lt;/Jx&gt;
 * </pre>
 * 
 * <pre>
 ...
 * 
 * 
 * <p>Java class for ISODestCntry_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ISODestCntry_Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "ISODestCntry_Type", propOrder = {
    "value"
})
public class ISODestCntryType {
