 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;Jx xmlns="http://jackhenry.com/jxchange/TPG/2008" xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;&lt;ElemDesc&gt;Defines the calculation/method of principal payment for Multi Level Lending &lt;/ElemDesc&gt;&lt;CanonicalVal&gt;CurBal,OrigBal,MatDt,OrigLnDt&lt;/CanonicalVal&gt;&lt;ElemCanocType&gt;The values represent the following payment options: 
 *                         CurBal = Based off the outstanding loan balance to the tranche balance 
 *                         OrigBal = Based off the original loan amount to the tranche balance 
 *                         MatDt = Based off the Tranche maturity date.  Funds would be paid off starting w/ the earliest maturity date
 *                         OrigLnDt = Based off the original loan date.  Payments would be made to the oldest loan date 
 *                     &lt;/ElemCanocType&gt;&lt;/Jx&gt;
 * </pre>
 * 
 * 
 * <p>Java class for PrincPmtMthd_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PrincPmtMthd_Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "PrincPmtMthd_Type", propOrder = {
    "value"
})
public class PrincPmtMthdType {
