 ...
 *                 transfer amount should behave if the To AcctId is a Loan and the loan has late
 *                 charges due 
 * <pre>
 ...
 * 
 * 
 * <p>Java class for FutXferLateChgDesc_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FutXferLateChgDesc_Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "FutXferLateChgDesc_Type", propOrder = {
    "value"
})
public class FutXferLateChgDescType {
