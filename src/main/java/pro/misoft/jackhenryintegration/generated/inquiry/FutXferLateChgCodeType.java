...
/**
 * The code that references how the transfer amount should
 *                 behave if the To AcctId is a Loan and the loan has late charges due 
 * <pre>
 ...
 * 
 * 
 * <p>Java class for FutXferLateChgCode_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FutXferLateChgCode_Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "FutXferLateChgCode_Type", propOrder = {
    "value"
})
public class FutXferLateChgCodeType {
