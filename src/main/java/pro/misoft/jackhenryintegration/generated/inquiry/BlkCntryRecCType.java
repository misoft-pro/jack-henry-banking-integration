...
/**
 * <p>Java class for BlkCntryRec_CType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BlkCntryRec_CType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="CntryConfdScore" type="{http://jackhenry.com/jxchange/TPG/2008}EntityConfdScore_Type" minOccurs="0"/&gt;
...
@XmlType(name = "BlkCntryRec_CType", propOrder = {
    "cntry",
    "cntryType",
    "cntryConfdScore",
    "custom",
...
public class BlkCntryRecCType {

    @XmlElement(name = "Cntry")
    protected CntryType cntry;
    @XmlElement(name = "CntryType")
    protected CntryTypeType cntryType;
    @XmlElement(name = "CntryConfdScore")
    protected EntityConfdScoreType cntryConfdScore;
    ...
    /**
     * Gets the value of the cntryConfdScore property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public EntityConfdScoreType getCntryConfdScore() {
        return cntryConfdScore;
    }

    /**
     * Sets the value of the cntryConfdScore property.
     * 
     * @param value
     *     allowed object is
     *     {@link EntityConfdScoreType }
     *     
     */
    public void setCntryConfdScore(EntityConfdScoreType value) {
        this.cntryConfdScore = value;
    }
