...
/**
 * Group Code This code is used to group loans of
 *                 different types for general ledger reporting purposes. It may also be used to group
 *                 customer accounts together 
 * 
 * <p>Java class for GroupCode_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GroupCode_Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "GroupCode_Type", propOrder = {
    "value"
})
